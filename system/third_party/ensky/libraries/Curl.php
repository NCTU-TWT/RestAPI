...
*/
	...
	private function initial () {
		...
		$this->meta->useragent = 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:6.0) Gecko/20100101 Firefox/6.0';
		return $this;
	}
	...
	public function getData_multi_tmp($urls,$ref=False){
		if( !is_dir($this->tmpFolder) ){
			...
			if( !is_dir($this->tmpFolder) ){
				throw new Exception("CURL : getData_multi_tmp: can't open new tmp folder.");
			}
		}
		$fileNames=array();
		foreach( $urls as $url ){
